                    ...
                    <ul class="navbar-navigation-dropdown rd-navbar-dropdown">
                      ...
                      <li class="navbar-navigation-dropdown-item active"><a class="navbar-navigation-dropdown-link" href="#">Blog</a>
                        <ul class="navbar-navigation-dropdown rd-navbar-dropdown">
                          ...
                          <li class="navbar-navigation-dropdown-item active"><a class="navbar-navigation-dropdown-link" href="blog-post.html">Blog post</a>
                          </li>
                        </ul>
                      </li>
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-10 col-xl-8">
              <h2 class="h1 page-title-text">9 Ways Your Funeral Home Can Support Grieving Families</h2>
            </div>
          </div>
        </div>
      </section>
      ...
      <section class="section-md bg-transparent">
        <div class="container">
          <div class="row row-40 justify-content-xxl-between">
            <div class="col-md-8">
              <div class="blog-post">
                <div class="blog-post-item"><img src="images/blog-post-01-796x431.jpg" alt="" width="796" height="431"/>
                  <h3>How to Support Grieving Families</h3>
                  <div class="post-meta list list-inline-divided text-small">
                    <div class="list-item">
                      <div class="post-tags"><a class="post-tag" href="#">News</a></div>
                    </div>
                    <div class="list-item"><a class="post-date" href="#">April 10, 2020</a></div>
                    <div class="list-item"><a class="post-comments" href="#">0 comments</a></div>
                  </div>
                  <p>Adipiscing inciderint est in. Ius nusquam oportere et, ius ea mazim definiebas scribentur, ne putent verterem necessitatibus quo. No quem nulla graece quo. Duo erat dicat.</p>
                  <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam sed do eiusmod tempor. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam sed do eiusmod tempor. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p><img src="images/blog-post-02-796x431.jpg" alt="" width="796" height="431"/>
                  <h3>Offering Grief Care</h3>
                  <p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis quasi.</p>
                        ...
                        <div class="quote quote-default quote-default-light quote-default-light">
                          ...
                          <div class="quote-body">
                            <q class="quote-text h3">Mel tale nonumy ea. Illum dicunt usu te. Ne iisque equidem definitionem usu, vis facer labitur suscipit</q>
                            <cite class="quote-cite">Jose Reed, Director</cite>
                          </div>
                        </div>
                  <div class="row row-15">
                    <div class="col-sm-6"><img src="images/blog-post-03-349x358.jpg" alt="" width="349" height="358"/>
                    </div>
                    <div class="col-sm-6">
                      ...
                      <div class="row row-5 row-content row-gutters-5">
                        <div class="col-lg-6">
                          <ul class="list list-marked">
                            <li class="list-item">Be there to listen</li>
                            <li class="list-item">Offer specific help</li>
                            <li class="list-item">Create a care package</li>
                          </ul>
                        </div>
                        <div class="col-lg-6">
                          <ul class="list list-marked">
                            <li class="list-item">Help you decide</li>
                            <li class="list-item">Offer support</li>
                          </ul>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="row row-15 justify-content-between align-items-center">
                    <div class="col-sm-6">
                      <div class="group-10"><a class="tag tag-outline" href="#">News</a><a class="tag tag-outline" href="#">Blog</a><a class="tag tag-outline" href="#">Funeral</a></div>
                    </div>
                    <div class="col-sm-6">
                      <div class="group-10 d-flex align-items-center justify-content-sm-end"><span>Share post:</span><a class="icon icon-md icon-link icon-link-gray mdi-facebook" href="#"></a><a class="icon icon-md icon-link icon-link-gray mdi-linkedin" href="#"></a><a class="icon icon-md icon-link icon-link-gray mdi-twitter" href="#"></a></div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="row row-20 row-content">
                    <div class="col-xs-11 col-sm-6">
                            ...
                            <div class="post post-line">
                              <div class="post-tags text-small"><a class="post-tag" href="classic-blog.html">News</a></div><a class="post-media" href="blog-post.html"><img src="images/blog-post-04-368x228.jpg" alt="" width="368" height="228"/>
                                <div class="post-hover-btn mdi-link-variant"></div></a>
                              <div class="post-content">
                                <h4 class="post-title"><a href="blog-post.html">10 Inspirational Quotations About Grief and Comforting</a></h4>
                                <div class="post-date text-small">November 12, 2020</div>
                              </div>
                            </div>
                    </div>
                    <div class="col-xs-11 col-sm-6">
                            <!-- Post-->
                            <div class="post post-line">
                              <div class="post-tags text-small"><a class="post-tag" href="classic-blog.html">News</a></div><a class="post-media" href="blog-post.html"><img src="images/blog-post-05-369x228.jpg" alt="" width="369" height="228"/>
                                <div class="post-hover-btn mdi-link-variant"></div></a>
                              <div class="post-content">
                                <h4 class="post-title"><a href="blog-post.html">Sympathy Flowers: A Guide to Sending Flowers for Funerals</a></h4>
                                <div class="post-date text-small">November 12, 2020</div>
                              </div>
                            </div>
                    </div>
            ...
            <div class="col-md-4 col-xl-3">
              ...
              <div class="widget">
                ...
                <div class="widget-body">
                  <ul class="list list-divided list-divided-sm big">
                    ...
                    <li class="list-item"><a class="link link-arrow" href="#">Funeral</a></li>
                    <li class="list-item"><a class="link link-arrow" href="#">Tips</a></li>
              ...
              <div class="widget">
                ...
                <div class="widget-body">
                        <!-- Post small-->
                        <div class="post post-small"><a class="post-img-link" href="blog-post.html"><img src="images/latest-post-01-72x72.jpg" alt="" width="72" height="72"/></a>
                          <div class="post-body">
                            <h5 class="post-title"><a href="blog-post.html">How to Choose a Funeral Home</a></h5>
                            <div class="post-date text-small">May 10, 2020</div>
                          </div>
                        </div>
                        <!-- Post small-->
                        <div class="post post-small"><a class="post-img-link" href="blog-post.html"><img src="images/latest-post-02-72x72.jpg" alt="" width="72" height="72"/></a>
                          <div class="post-body">
                            <h5 class="post-title"><a href="blog-post.html">How to Help a Grieving Friend
</a></h5>
                            <div class="post-date text-small">May 10, 2020</div>
                          </div>
                        </div>
              ...
              <div class="widget">
                ...
                <div class="widget-body">
                  <div class="group-10"><a class="tag tag-outline" href="#">News</a><a class="tag tag-outline" href="#">Blog</a><a class="tag tag-outline" href="#">Funeral</a><a class="tag tag-outline" href="#">Floral</a><a class="tag tag-outline" href="#">Tips</a></div>
                </div>
              </div>
            </div>
          </div>
