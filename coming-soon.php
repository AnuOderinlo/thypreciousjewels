...
<html lang="en">
  ...
  <body>
    <div class="page">
      <!-- Coming soon-->
      <section class="section-xs service-section service-section-fullwidth bg-image context-dark text-center" style="background-image: url(images/bg-coming-soon.jpg)">
          ...
          <div class="container">
            <div class="row row-30 row-xl-55 justify-content-center">
              <div class="col-md-10 col-lg-8">
                <h2>Coming Soon</h2>
                <p class="big">Our website is under construction, we are working very hard to give you the best experience on our website. Subscribe to us to be notified of our launch.</p>
                      <!-- Countdown-->
                      <div class="countdown justify-content-center" data-countdown='{"to":"2020-12-31"}'>
              ...
              <div class="col-md-10 col-lg-6">
                <form class="form-inline rd-mailform rd-form group-15 justify-content-center" data-form-output="form-coming-soon" data-form-type="subscribe" method="post" action="components/rd-mailform/rd-mailform.php">
                  <div class="form-inline-group">
                    <input class="form-control" type="email" name="email" placeholder="Your E-mail*" data-constraints="@Email @Required">
                  </div>
                  <button class="btn">Subscribe</button>
                </form>
                <div class="form-output snackbar snackbar-primary" id="form-coming-soon"></div>
              </div>
            </div>
          </div>
        </div>
        <div class="service-section-footer">
          <div class="container">
                  <!-- Copyright-->
                  <p class="rights"><span>&copy; 2020&nbsp;</span><span>Eternity</span><span>. All rights reserved.&nbsp;</span><a class="link link-inherit rights-link" href="privacy-policy.html">Privacy Policy</a></p>
          </div>
        </div>
      </section>
    </div>
