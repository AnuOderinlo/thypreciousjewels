...
<html lang="en">
  ...
  <body>
    <div class="page">
      <!-- Page title-->
      <section class="section page-title bg-image context-dark" style="background-image: url(img/contact_us_banner.jpg);">
        <!--RD Navbar-->
        <?php include 'template/header.php'; ?>
        <div class="container">
          <div class="row">
            <div class="col-md-10 col-xl-8">
              <h2 class="h1 page-title-text">Contacts</h2>
            </div>
          </div>
        </div>
      </section>
            ...
            <div class="col-sm-5 col-md-4">
              ...
              <div class="blurb blurb-info">
                ...
                <div class="blurb-embed">
                  <h5>793 Hickory Road Brooklyn, NY 11230</h5>
                </div>
              </div>
              <!-- Blurb info-->
              <div class="blurb blurb-info text-dark">
                ...
                <div class="blurb-embed"><a class="link link-inherit big2" href="tel:#">+447478002575</a>
                </div>
              </div>
              <!-- Blurb info-->
              <div class="blurb blurb-info">
                ...
                <div class="blurb-embed">
                  <h5><a href="mailto:info@thypreciousjewels.com">info@thypreciousjewels.com</a></h5>
                </div>
              </div>
            </div>
