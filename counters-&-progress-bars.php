...
<html lang="en">
  <head>
    <title>Counters &amp; Progress Bars</title>
    <meta charset="utf-8">
    ...
    <div class="page">
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-10 col-xl-8">
              <h2 class="h1 page-title-text">Counters &amp; Progress Bars</h2>
            </div>
          </div>
        </div>
      </section>
      ...
      <section class="section-md bg-transparent">
        <div class="container">
          <div class="row row-30 justify-content-between align-items-center">
            <div class="col-md-6">
              <h2>Skill Bars</h2>
                    ...
                    <div class="progress-linear">
                      <div class="progress-linear-title h4">Dedication<span class="progress-linear-counter-wrap"><span class="progress-linear-counter">88</span>%</span>
                      </div>
                    ...
                    <!-- Linear progress bar-->
                    <div class="progress-linear">
                      <div class="progress-linear-title h4">Knowledge<span class="progress-linear-counter-wrap"><span class="progress-linear-counter">70</span>%</span>
                      </div>
                      <div class="progress-linear-body">
                        <div class="progress-linear-bar"></div>
                      </div>
                    ...
                    <!-- Linear progress bar-->
                    <div class="progress-linear">
                      <div class="progress-linear-title h4">Experience<span class="progress-linear-counter-wrap"><span class="progress-linear-counter">74</span>%</span>
                      </div>
                      <div class="progress-linear-body">
                        <div class="progress-linear-bar"></div>
                      </div>
                    ...
                    <!-- Linear progress bar-->
                    <div class="progress-linear">
                      <div class="progress-linear-title h4">Professionalism<span class="progress-linear-counter-wrap"><span class="progress-linear-counter">68</span>%</span>
                      </div>
                      <div class="progress-linear-body">
                        <div class="progress-linear-bar"></div>
                      </div>
            ...
            <div class="col-md-6 col-xl-5 text-center text-md-right"><img src="images/image-1-470x331.jpg" alt="" width="470" height="331"/>
            </div>
          </div>
        </div>
      </section>
          ...
          <div class="row row-30 row-offset-md">
            <div class="col-6 col-md-3">
                    ...
                    <div class="counter counter-bordered">
                      <div class="counter-value"><span data-counter="">72</span><span class="counter-unit">%</span><span class="counter-icon linearicons-umbrella"></span>
                      </div>
                      <div class="counter-title">Reliability</div>
                    </div>
            </div>
            <div class="col-6 col-md-3">
                    <!-- Counter-->
                    <div class="counter counter-bordered">
                      <div class="counter-value"><span data-counter="">87</span><span class="counter-unit">%</span><span class="counter-icon linearicons-file-check"></span>
                      </div>
                      <div class="counter-title">Resilience</div>
                    </div>
            </div>
            <div class="col-6 col-md-3">
                    <!-- Counter-->
                    <div class="counter counter-bordered">
                      <div class="counter-value"><span data-counter="">25</span><span class="counter-unit">%</span><span class="counter-icon linearicons-bookmark2"></span>
                      </div>
                      <div class="counter-title">Trust</div>
                    </div>
            </div>
            <div class="col-6 col-md-3">
                    <!-- Counter-->
                    <div class="counter counter-bordered">
                      <div class="counter-value"><span data-counter="">32</span><span class="counter-unit">%</span><span class="counter-icon linearicons-bubble-quote"></span>
                      </div>
                      <div class="counter-title">Support</div>
                    </div>
            </div>
          </div>
        </div>
      ...
      <section class="section-md bg-transparent">
        <div class="container">
          <h2>Timer</h2>
                <!-- Countdown-->
                <div class="countdown" data-countdown='{"to":"2020-12-31"}'>
