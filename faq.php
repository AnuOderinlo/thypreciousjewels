                ...
                <ul class="navbar-navigation rd-navbar-nav">
                  ...
                  <li class="navbar-navigation-root-item active"><a class="navbar-navigation-root-link" href="#">Pages</a>
                    <ul class="navbar-navigation-dropdown rd-navbar-dropdown">
                      ...
                      <li class="navbar-navigation-dropdown-item active"><a class="navbar-navigation-dropdown-link" href="faq.html">FAQ</a>
                      </li>
                    </ul>
                  </li>
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-10 col-xl-8">
              <h2 class="h1 page-title-text">FAQ</h2>
            </div>
          </div>
        </div>
      </section>
      <!-- FAQ-->
      <section class="section-md bg-image" style="background-image: url( images/bg-faq.jpg )">
        <div class="container">
          <div class="row row-30 flex-md-row-reverse">
            <div class="col-md-4" data-animate='{"class":"fadeInRightBig"}'>
              <div class="tab">
                <div class="nav-creative-container">
                  <ul class="nav nav-creative" role="tablist">
                    <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#navCreative1-1" role="tab" aria-selected="true"><span class="nav-link-prefix"></span>Main questions</a></li>
                    <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#navCreative1-2" role="tab" aria-selected="false"><span class="nav-link-prefix"></span>Planning</a></li>
                    <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#navCreative1-3" role="tab" aria-selected="false"><span class="nav-link-prefix"></span>Arrangements</a></li>
                    <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#navCreative1-4" role="tab" aria-selected="false"><span class="nav-link-prefix"></span>other questions</a></li>
                  </ul>
                </div>
              </div>
            </div>
            <div class="col-md-8" data-animate='{"class":"fadeInLeftBig"}'>
              <div class="tab-content">
                <div class="tab-pane fade show active" id="navCreative1-1" role="tabpanel">
                  <h2>Popular Questions</h2>
                  <dl class="term-list term-list-divided">
                    <dt class="h4">What are the advantages of purchasing a website template?</dt>
                    <dd>The major advantage is price: You get a quality design for just $20-$70. You don’t have to hire a web designer or web design studio. Second advantage is time: it takes 5-15 days for a good designer to produce a web page of such quality.</dd>
                  </dl>
                  <dl class="term-list term-list-divided">
                    <dt class="h4">Do you provide any scripts with your templates?</dt>
                    <dd>Our templates do not include any additional scripts. Newsletter subscriptions, search fields, forums, image galleries are inactive. Basic scripts can be easily added at www.zemez.io If you are not sure that the element you’re interested in is active please contact our Support Chat for clarification.</dd>
                  </dl>
                  <dl class="term-list term-list-divided">
                    <dt class="h4">What do I receive when I order a template from Zemez?</dt>
                    <dd>After completing the payment, you will get access to the product.  The source files in the package can vary depending on the product you have purchased.</dd>
                  </dl>
                </div>
                <div class="tab-pane fade" id="navCreative1-3" role="tabpanel">
                  <h2>Popular Questions</h2>
                  <dl class="term-list term-list-divided">
                    <dt class="h4">Do you provide any scripts with your templates?</dt>
                    <dd>Our templates do not include any additional scripts. Newsletter subscriptions, search fields, forums, image galleries are inactive. Basic scripts can be easily added at www.zemez.io If you are not sure that the element you’re interested in is active please contact our Support Chat for clarification.</dd>
                ...
                <div class="tab-pane fade" id="navCreative1-4" role="tabpanel">
                  <h2>Popular Questions</h2>
                  <dl class="term-list term-list-divided">
                    <dt class="h4">What do I receive when I order a template from Zemez?</dt>
                    <dd>After completing the payment, you will get access to the product.  The source files in the package can vary depending on the product you have purchased.</dd>
                ...
                <div class="tab-pane fade" id="navCreative1-2" role="tabpanel">
                  <h2>Popular Questions</h2>
                  <dl class="term-list term-list-divided">
                    <dt class="h4">Do you provide any scripts with your templates?</dt>
                    <dd>Our templates do not include any additional scripts. Newsletter subscriptions, search fields, forums, image galleries are inactive. Basic scripts can be easily added at www.zemez.io If you are not sure that the element you’re interested in is active please contact our Support Chat for clarification.</dd>
