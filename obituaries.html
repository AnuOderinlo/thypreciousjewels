        ...
        <div class="container">
          <div class="row">
            <div class="col-md-10 col-xl-8">
              <h2 class="h1 page-title-text">Obituaries</h2>
            </div>
          </div>
        </div>
      </section>
      <!-- Our team-->
      <section class="section-md bg-100 context-dark text-center">
        <div class="container">
          <div class="row row-30">
            <div class="col-sm-6 col-lg-4">
                    <!-- Person-->
                    <div class="person person-boxed"><img class="person-img" src="images/obituaries-01-370x302.jpg" alt="" width="370" height="302"/>
                      <div class="person-inner">
                        <div class="person-inner-item person-content">
                          <h4 class="person-title"><a href="single-obituary.html">Anthony Green</a></h4>
                          <p class="person-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                          <div class="person-divider"></div>
                          <div class="person-meta">October 7, 1927 - March 18, 2019</div>
                        </div>
                        <div class="person-inner-item"><a class="person-button" href="single-obituary.html"><span class="mdi mdi-arrow-right"></span></a></div>
                      </div>
                    </div>
            </div>
            <div class="col-sm-6 col-lg-4">
                    <!-- Person-->
                    <div class="person person-boxed"><img class="person-img" src="images/obituaries-02-370x302.jpg" alt="" width="370" height="302"/>
                      <div class="person-inner">
                        <div class="person-inner-item person-content">
                          <h4 class="person-title"><a href="single-obituary.html">Emily Mitchell</a></h4>
                          <p class="person-text">Ut enim ad minim veniam, quis nostrud exercitation ullamco.</p>
                          <div class="person-divider"></div>
                          <div class="person-meta">October 7, 1927 - March 18, 2019</div>
                        </div>
                        <div class="person-inner-item"><a class="person-button" href="single-obituary.html"><span class="mdi mdi-arrow-right"></span></a></div>
            ...
            <div class="col-sm-6 col-lg-4">
                    <!-- Person-->
                    <div class="person person-boxed"><img class="person-img" src="images/obituaries-03-370x302.jpg" alt="" width="370" height="302"/>
                      <div class="person-inner">
                        <div class="person-inner-item person-content">
                          <h4 class="person-title"><a href="single-obituary.html">Oliver Barnett</a></h4>
                          <p class="person-text">Duis aute irure dolor in reprehenderit in voluptate.</p>
                          <div class="person-divider"></div>
                          <div class="person-meta">October 7, 1927 - March 18, 2019</div>
                        </div>
                        <div class="person-inner-item"><a class="person-button" href="single-obituary.html"><span class="mdi mdi-arrow-right"></span></a></div>
            ...
            <div class="col-sm-6 col-lg-4">
                    <!-- Person-->
                    <div class="person person-boxed"><img class="person-img" src="images/obituaries-04-370x302.jpg" alt="" width="370" height="302"/>
                      <div class="person-inner">
                        <div class="person-inner-item person-content">
                          <h4 class="person-title"><a href="single-obituary.html">Marilyn Adams</a></h4>
                          <p class="person-text">Excepteur sint occaecat cupidatat non proident, sunt in.</p>
                          <div class="person-divider"></div>
                          <div class="person-meta">October 7, 1927 - March 18, 2019</div>
                        </div>
                        <div class="person-inner-item"><a class="person-button" href="single-obituary.html"><span class="mdi mdi-arrow-right"></span></a></div>
            ...
            <div class="col-sm-6 col-lg-4">
                    <!-- Person-->
                    <div class="person person-boxed"><img class="person-img" src="images/obituaries-05-370x302.jpg" alt="" width="370" height="302"/>
                      <div class="person-inner">
                        <div class="person-inner-item person-content">
                          <h4 class="person-title"><a href="single-obituary.html">George Butler</a></h4>
                          <p class="person-text">Sed ut perspiciatis unde omnis iste natus error sit.</p>
                          <div class="person-divider"></div>
                          <div class="person-meta">October 7, 1927 - March 18, 2019</div>
                        </div>
                        <div class="person-inner-item"><a class="person-button" href="single-obituary.html"><span class="mdi mdi-arrow-right"></span></a></div>
            ...
            <div class="col-sm-6 col-lg-4">
                    <!-- Person-->
                    <div class="person person-boxed"><img class="person-img" src="images/obituaries-06-370x302.jpg" alt="" width="370" height="302"/>
                      <div class="person-inner">
                        <div class="person-inner-item person-content">
                          <h4 class="person-title"><a href="single-obituary.html">Harry Young</a></h4>
                          <p class="person-text">Nemo enim ipsam voluptatem quia voluptas sit aspernatur.</p>
                          <div class="person-divider"></div>
                          <div class="person-meta">October 7, 1927 - March 18, 2019</div>
                        </div>
                        <div class="person-inner-item"><a class="person-button" href="single-obituary.html"><span class="mdi mdi-arrow-right"></span></a></div>
