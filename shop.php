            ...
            <div class="navbar-container">
              ...
              <div class="navbar-cell">
                <ul class="navbar-navigation rd-navbar-nav">
                  ...
                  <li class="navbar-navigation-root-item active"><a class="navbar-navigation-root-link" href="shop.html">Shop</a>
                    <ul class="navbar-navigation-dropdown rd-navbar-dropdown">
                      <li class="navbar-navigation-back">
                        <button class="navbar-navigation-back-btn">Back</button>
                      </li>
          ...
          <div class="row row-40">
            <div class="col-md-8 col-lg-9">
              <div class="row row-40 row-xl-55">
                <div class="col-6 col-lg-4">
                        <!-- Product-->
                        <div class="product product-simple"><a class="product-media" href="single-product.html"><img src="images/shop-01-270x359.jpg" alt="" width="270" height="359"/></a>
                          <h4 class="product-title"><a href="single-product.html">Dreams from the Heart</a></h4>
                          <div class="h4 product-price">$35.00</div>
                        </div>
                </div>
                <div class="col-6 col-lg-4">
                        <!-- Product-->
                        <div class="product product-simple"><a class="product-media" href="single-product.html"><img src="images/shop-02-270x359.jpg" alt="" width="270" height="359"/></a>
                          <h4 class="product-title"><a href="single-product.html">Tulips Bouquet</a></h4>
                          <div class="h4 product-price">$35.00</div>
                        </div>
                </div>
                <div class="col-6 col-lg-4">
                        <!-- Product-->
                        <div class="product product-simple"><a class="product-media" href="single-product.html"><img src="images/shop-03-270x359.jpg" alt="" width="270" height="359"/></a>
                          <h4 class="product-title"><a href="single-product.html">Thoughtful Lily Bouquet</a></h4>
                          <div class="h4 product-price">$35.00</div>
                        </div>
                </div>
                <div class="col-6 col-lg-4">
                        <!-- Product-->
                        <div class="product product-simple"><a class="product-media" href="single-product.html"><img src="images/shop-04-270x359.jpg" alt="" width="270" height="359"/></a>
                          <h4 class="product-title"><a href="single-product.html">51 multicolored tulips
</a></h4>
                          <div class="h4 product-price">$35.00</div>
                        </div>
                </div>
                <div class="col-6 col-lg-4">
                        <!-- Product-->
                        <div class="product product-simple"><a class="product-media" href="single-product.html"><img src="images/shop-05-270x359.jpg" alt="" width="270" height="359"/></a>
                          <h4 class="product-title"><a href="single-product.html">Miracle's Light Vase</a></h4>
                          <div class="h4 product-price">$35.00</div>
                        </div>
                </div>
                <div class="col-6 col-lg-4">
                        <!-- Product-->
                        <div class="product product-simple"><a class="product-media" href="single-product.html"><img src="images/shop-06-270x359.jpg" alt="" width="270" height="359"/></a>
                          <h4 class="product-title"><a href="single-product.html">Burst of Light Bouquet</a></h4>
                          <div class="h4 product-price">$35.00</div>
                        </div>
                </div>
              </div>
            ...
            <div class="col-md-4 col-lg-3">
              ...
              <div class="widget">
                ...
                <div class="widget-body">
                        <!-- Product small-->
                        <div class="product product-small"><a class="product-img-link" href="single-product.html"><img src="images/product-thumb-01-72x91.jpg" alt="" width="72" height="91"/></a>
                          <div class="product-body">
                            <h5 class="product-title"><a href="single-product.html">Dreams from the Heart Bouquet</a></h5>
                            <div class="product-price">$35</div>
                          </div>
                        </div>
                        <!-- Product small-->
                        <div class="product product-small"><a class="product-img-link" href="single-product.html"><img src="images/product-thumb-02-72x91.jpg" alt="" width="72" height="91"/></a>
                          <div class="product-body">
                            <h5 class="product-title"><a href="single-product.html">Tulips Sympathy Bouquet</a></h5>
                            <div class="product-price">$35</div>
                          </div>
                        </div>
                </div>
