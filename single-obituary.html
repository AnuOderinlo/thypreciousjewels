                ...
                <ul class="navbar-navigation rd-navbar-nav">
                  <li class="navbar-navigation-root-item active"><a class="navbar-navigation-root-link" href="about-us.html">About Us</a>
                    <ul class="navbar-navigation-dropdown rd-navbar-dropdown">
                      ...
                      <li class="navbar-navigation-dropdown-item active"><a class="navbar-navigation-dropdown-link" href="obituaries.html">Obituaries</a>
                        <ul class="navbar-navigation-dropdown rd-navbar-dropdown">
                          <li class="navbar-navigation-back">
                            <button class="navbar-navigation-back-btn">Back</button>
                          </li>
                          <li class="navbar-navigation-dropdown-item active"><a class="navbar-navigation-dropdown-link" href="single-obituary.html">Single Obituary</a>
                          </li>
                        </ul>
                      </li>
                    </ul>
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-10 col-xl-8">
              <h2 class="h1 page-title-text">Single Obituary</h2>
            </div>
          </div>
        </div>
      </section>
        ...
        <div class="container">
          <div class="row row-30 justify-content-center justify-content-sm-between">
            <div class="col-8 col-8 col-md-6 col-lg-5 text-center text-md-left">
              <div class="image-block"><img src="images/single-obituary-01-469x565.jpg" alt="" width="469" height="565"/>
            ...
            <div class="col-md-6">
              <div class="group-5 d-flex flex-wrap align-items-center justify-content-between">
                <h2>Emily Mitchell</h2>
              </div>
              <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam sed do eiusmod tempor.</p>
              <div class="address">
                <table>
                  <tr>
                    <td class="address-title">Date of birth:</td>
                    <td class="big">October 7, 1927</td>
                  </tr>
                  <tr>
                    <td class="address-title">Date of death:</td>
                    <td class="big">March 18, 2019</td>
                  </tr>
                </table>
              </div>
              <p>Consequat tellus ut aliquam aliquam a ultricies felis, condimentum amet. Integer ipsum sapien consequat morbi. Vulputate quis vitae.</p>
              <p>Pharetra, aliquam id fames fames placerat. Cursus risus eget a blandit suspendisse amet egestas euismod. Consectetur vel accumsan pellentesque vitae integer. Egestas tempor dui interdum egestas diam.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section class="section-md bg-100">
        <div class="container">
          <div class="row row-30 justify-content-between align-items-end">
            ...
            <div class="col-md-6">
              <div class="text-block-2">
                <div class="text-small text-primary text-divider text-divider-wide">In memory of Emily Mitchell</div>
            ...
            <div class="col-md-11">
                    ...
                    <div class="quote quote-default quote-default-light quote-default-light">
                      ...
                      <div class="quote-body">
                        ...
                        <cite class="quote-cite">Sam Mitchell</cite>
                      </div>
                    </div>
            </div>
          </div>
            ...
            <div class="swiper-container" data-swiper='{"breakpoints":{"576":{"slidesPerView":2,"spaceBetween":15},"768":{"slidesPerView":3,"spaceBetween":30}},"loop":false,"pagination":{"type":"custom"}}'>
              ...
              <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                        <!-- Post-->
                        <div class="post post-shadow"><a class="post-media" href="single-service.html"><img src="images/services-01-370x257.jpg" alt="" width="370" height="257"/>
                            <div class="post-hover-btn">View</div></a>
                          <div class="post-content">
                            <div class="post-tags group-5 text-small"><span class="post-tag">from $535</span></div>
                            <h4 class="post-title"><a href="single-service.html">Burials</a></h4>
                ...
                <div class="swiper-slide">
                        <!-- Post-->
                        <div class="post post-shadow"><a class="post-media" href="single-service.html"><img src="images/services-02-370x257.jpg" alt="" width="370" height="257"/>
                            <div class="post-hover-btn">View</div></a>
                          <div class="post-content">
                            <div class="post-tags group-5 text-small"><span class="post-tag">from $535</span></div>
                            <h4 class="post-title"><a href="single-service.html">Floral Arrangements</a></h4>
                ...
                <div class="swiper-slide">
                        <!-- Post-->
                        <div class="post post-shadow"><a class="post-media" href="single-service.html"><img src="images/services-03-370x257.jpg" alt="" width="370" height="257"/>
                            <div class="post-hover-btn">View</div></a>
                          <div class="post-content">
                            <div class="post-tags group-5 text-small"><span class="post-tag">from $535</span></div>
                            <h4 class="post-title"><a href="single-service.html">Memorial Services</a></h4>
                ...
                <div class="swiper-slide">
                        <!-- Post-->
                        <div class="post post-shadow"><a class="post-media" href="single-service.html"><img src="images/services-04-370x257.jpg" alt="" width="370" height="257"/>
                            <div class="post-hover-btn">View</div></a>
                          <div class="post-content">
                            <div class="post-tags group-5 text-small"><span class="post-tag">from $535</span></div>
                            <h4 class="post-title"><a href="single-service.html">Cremations</a></h4>
                ...
                <div class="swiper-slide">
                        <!-- Post-->
                        <div class="post post-shadow"><a class="post-media" href="single-service.html"><img src="images/services-05-370x257.jpg" alt="" width="370" height="257"/>
                            <div class="post-hover-btn">View</div></a>
                          <div class="post-content">
                            <div class="post-tags group-5 text-small"><span class="post-tag">from $535</span></div>
                            <h4 class="post-title"><a href="single-service.html">Ship-Outs</a></h4>
                ...
                <div class="swiper-slide">
                        <!-- Post-->
                        <div class="post post-shadow"><a class="post-media" href="single-service.html"><img src="images/services-06-370x257.jpg" alt="" width="370" height="257"/>
                            <div class="post-hover-btn">View</div></a>
                          <div class="post-content">
                            <div class="post-tags group-5 text-small"><span class="post-tag">from $535</span></div>
                            <h4 class="post-title"><a href="single-service.html">Funeral Planning</a></h4>
