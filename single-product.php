        ...
        <div class="container">
          <div class="row">
            <div class="col-md-10 col-xl-8">
              <h2 class="h1 page-title-text">Single product</h2>
            </div>
          </div>
        </div>
      </section>
      ...
      <section class="section-md bg-transparent">
        <div class="container">
          <div class="row row-25 row-xl-55 justify-content-between">
            <div class="col-sm-6 col-lg-5"><img class="shadow-sm image image-sm" src="images/single-product-01-470x623.jpg" alt="" width="470" height="623"/>
            </div>
            <div class="col-md-6 col-lg-6">
              <div class="product-overview">
                <h2>Dreams from the Heart Sympathy Bouquet</h2>
                <div class="product-overview-price"><span class="product-overview-price-old big">$60.00</span><span class="product-overview-price-new h3">$35.00</span></div>
                <p class="big">Adipiscing inciderint est in. Ius nusquam oportere et, ius ea mazim definiebas scribentur, ne putent verterem necessitatibus quo. No quem nulla graece quo.</p>
          ...
          <div class="tab tab-classic">
            ...
            <div class="tab-content">
              ...
              <div class="tab-pane fade" id="navClassic1-2" role="tabpanel">
                ...
                <h5>Be the first to review “Dreams from the Heart Sympathy Bouquet”</h5>
