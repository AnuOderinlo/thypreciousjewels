  ...
  <body>
    <div class="page">
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-10 col-xl-8">
              <h2 class="h1 page-title-text">Floral Arrangements</h2>
            </div>
          </div>
        </div>
      </section>
      ...
      <section class="section-md bg-transparent">
        <div class="container">
          <div class="row row-30 row-xl-55 row-xxl-100 justify-content-between">
            <div class="col-md-8"><img src="images/single-service-01-769x431.jpg" alt="" width="769" height="431"/>
              <h2>Sympathy Flowers for Funerals</h2>
              ...
              <div class="row row-25 row-offset-md">
                <div class="col-sm-6"><img src="images/single-service-02-349x373.jpg" alt="" width="349" height="373"/>
                </div>
                <div class="col-sm-6">
                  ...
                  <div class="row row-5 row-content row-gutters-5">
                    <div class="col-lg-6">
                      <ul class="list list-marked text-dark">
                        <li class="list-item">Standing Sprays</li>
                        <li class="list-item">Funeral Bouquets</li>
                        <li class="list-item">Sympathy Bouquets</li>
                      </ul>
                    </div>
                    <div class="col-lg-6">
                      <ul class="list list-marked text-dark">
                        <li class="list-item">Urn Tributes</li>
                        <li class="list-item">Sympathy Plants</li>
                      </ul>
                    </div>
                  </div>
                </div>
              </div>
              <h2>How to Buy Sympathy Flowers</h2>
              <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam sed do eiusmod tempor. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam sed do eiusmod tempor.</p>
            </div>
            <div class="col-md-4 col-xl-3">
              <h3 class="text-primary">Our Services</h3>
              <ul class="list list-divided list-divided-sm big">
                <li class="list-item"><a class="link link-arrow" href="#">Burials</a></li>
                <li class="list-item"><a class="link link-arrow" href="#">Memorial Services</a></li>
                <li class="list-item"><a class="link link-arrow" href="#">Floral Arrangements</a></li>
                <li class="list-item"><a class="link link-arrow" href="#">Cremations</a></li>
                <li class="list-item"><a class="link link-arrow" href="#">Ship-Outs</a></li>
                <li class="list-item"><a class="link link-arrow" href="#">Funeral Planning</a></li>
      ...
      <section class="section-md bg-100 text-center" id="consultation-form">
        <div class="container">
          <h2 data-animate='{"class":"fadeInUpBig"}'>Schedule a Free Consultation</h2>
          <div class="link-container" data-animate='{"class":"fadeInUpBig"}'><a class="link link-large" href="tel:#">800.567.1234</a></div>
          <form class="rd-mailform rd-form" data-form-output="form-consultation" data-form-type="contact" method="post" action="components/rd-mailform/rd-mailform.php" data-animate='{"class":"fadeInUpBig"}'>
