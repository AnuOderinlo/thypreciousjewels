      ...
      <div class="col-lg-6">
        <div class="group-10 group-x-50 d-flex flex-wrap">
          <div>
            <dl class="term-list term-list-inline">
              <dt>Tel: </dt>
              <dd><a class="link link-contrast" href="tel:+447478002575">+447478002575</a></dd>
            </dl>
          </div>
          <div>
            <dl class="term-list term-list-inline">
              <dt>E-mail: </dt>
              <dd><a class="link link-inherit" href="mailto:info@thypreciousjewels.com">info@thypreciousjewels.com</a></dd>
            </dl>
          </div>
        </div>
      </div>
    ...
    <div class="row row-15">
      <div class="col-sm-8 col-lg-6">
        <div class="group-10 group-x-xl-40 d-flex align-items-center flex-wrap">
                <!-- Copyright-->
                <p class="rights"><span>&copy; 2020&nbsp;</span><span>Thypreciousjewels</span><span>. All rights reserved.&nbsp;</span></p>
          <div>
            <div class="group-10 group-lg-30">
            	<a target="_blank" class="icon icon-md icon-link mdi-facebook" href="https://www.facebook.com/THYPRECIOUSJEWELS"></a>
            	<a target="_blank" class="icon icon-md icon-link mdi-youtube-play" href="https://www.youtube.com/c/THYPRECIOUSJEWELSTHYPRECIOUSJEWELS"></a>
            	<a target="_blank" class="icon icon-md icon-link mdi-instagram" href="https://www.instagram.com/THYPRECIOUSJEWELS/"></a>
            	<a target="_blank" class="icon icon-md icon-link mdi-twitter" href="https://twitter.com/OmobolaJeffreys"></a>
            </div>
          </div>
        </div>
      </div>
